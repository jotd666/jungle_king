...
12DD: F8          ret  m
12DE: F9          ld   sp,hl
12DF: FA FB FC    jp   m,$FCFB
12E2: F5          push af
12E3: F6 FF       or   $FF
12E5: F8          ret  m
12E6: F9          ld   sp,hl
12E7: FA FB FC    jp   m,$FCFB
12EA: F5          push af
12EB: F6 F7       or   $F7
12ED: F0          ret  p
12EE: F9          ld   sp,hl
12EF: FA FB FC    jp   m,$FCFB
12F2: 0E 0D       ld   c,$0D
12F4: 14          inc  d
12F5: 13          inc  de
12F6: 12          ld   (de),a
12F7: 11 10 17    ld   de,$1710
12FA: 16 15       ld   d,$15
12FC: 14          inc  d
12FD: 13          inc  de
12FE: 12          ld   (de),a
12FF: 11 10 17    ld   de,$1710
1302: 16 15       ld   d,$15
1304: 14          inc  d
1305: 13          inc  de
1306: 12          ld   (de),a
1307: 11 18 1F    ld   de,$1F18
130A: 00          nop
130B: 00          nop
130C: 00          nop
130D: 00          nop
130E: 01 00 00    ld   bc,$0000
1311: 00          nop
1312: 01 00 01    ld   bc,$0100
1315: 00          nop
1316: 01 01 01    ld   bc,$0101
1319: 00          nop
131A: 01 01 01    ld   bc,$0101
131D: 01 02 01    ld   bc,$0102
1320: 01 01 02    ld   bc,$0201
1323: 01 02 01    ld   bc,$0102
1326: 02          ld   (bc),a
1327: 02          ld   (bc),a
1328: 02          ld   (bc),a
1329: 01 02 02    ld   bc,$0202
132C: 02          ld   (bc),a
132D: 02          ld   (bc),a
132E: 03          inc  bc
132F: 02          ld   (bc),a
...
2F73: 00          nop
2F74: 02          ld   (bc),a
2F75: 10 02       djnz $2F79
2F77: 01 02 50    ld   bc,$5002
2F7A: 03          inc  bc
2F7B: 02          ld   (bc),a
2F7C: 02          ld   (bc),a
2F7D: 30 03       jr   nc,$2F82
2F7F: 03          inc  bc
2F80: 02          ld   (bc),a
2F81: 60          ld   h,b
2F82: 03          inc  bc
...
2F86: 04          inc  b
2F87: 05          dec  b
2F88: 01 F0 04    ld   bc,$04F0
2F8B: 06 02       ld   b,$02
2F8D: 50          ld   d,b
2F8E: 05          dec  b
2F8F: 07          rlca
2F90: 02          ld   (bc),a
2F91: 10 05       djnz $2F98
2F93: 08          ex   af,af'
2F94: 02          ld   (bc),a
2F95: 00          nop
2F96: 04          inc  b
2F97: 09          add  hl,bc
2F98: 01 F0 05    ld   bc,$05F0
2F9B: 0A          ld   a,(bc)
2F9C: 02          ld   (bc),a
2F9D: 30 05       jr   nc,$2FA4
2F9F: 0B          dec  bc
2FA0: 02          ld   (bc),a
2FA1: 60          ld   h,b
2FA2: 06 0C       ld   b,$0C
2FA4: 02          ld   (bc),a
2FA5: 10 06       djnz $2FAD
2FA7: 0D          dec  c
2FA8: 02          ld   (bc),a
2FA9: 20 06       jr   nz,$2FB1
2FAB: 0E 02       ld   c,$02
2FAD: 60          ld   h,b
2FAE: 06 0F       ld   b,$0F
2FB0: 00          nop
...
2FB7: 2F          cpl
2FB8: 00          nop
2FB9: 30 00       jr   nc,$2FBB
2FBB: 31 00 2C    ld   sp,$2C00
2FBE: 00          nop
2FBF: 2F          cpl
2FC0: 00          nop
2FC1: 32 00 33    ld   ($3300),a
2FC4: 00          nop
2FC5: 34          inc  (hl)
2FC6: 00          nop
2FC7: 35          dec  (hl)
...
2FCB: 37          scf
2FCC: 00          nop
2FCD: 32 00 35    ld   ($3500),a
2FD0: 00          nop
2FD1: 38 01       jr   c,$2FD4
2FD3: 38 00       jr   c,$2FD5
2FD5: 39          add  hl,sp
2FD6: 01 39 00    ld   bc,$0039
2FD9: 3A 01 3A    ld   a,($3A01)
2FDC: 00          nop
2FDD: 00          nop
2FDE: 00          nop
2FDF: 00          nop
...
2FF0: 2E 90       ld   l,$90
2FF2: 50          ld   d,b
2FF3: D4 5C 00    call nc,$005C
2FF6: 5B          ld   e,e
2FF7: 00          nop
2FF8: 2E A0       ld   l,$A0
2FFA: 50          ld   d,b
2FFB: D4 5C 00    call nc,$005C
2FFE: 5B          ld   e,e
2FFF: 00          nop
